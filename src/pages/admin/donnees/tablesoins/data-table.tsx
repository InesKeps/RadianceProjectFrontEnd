...
import type { SoinDto } from "@/types/consultationdatas"
    ...
    <section className="relative">
      <Dialog>
        <Card className="bg-[#f7f9fa]">
          <CardHeader>
            <CardTitle>Liste des soins prodigués par le cabinet</CardTitle>
            <CardDescription>
              <Input
                placeholder="Rechercher un soin...(entrez le nom du soin)"
