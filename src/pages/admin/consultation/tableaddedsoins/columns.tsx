...
import { removeSoin } from "@/store/soins/addedSoinSlice";
import type { SoinConsultation } from "@/types/consultationdatas"

export const columns: ColumnDef<SoinConsultation>[] = [
  {
