...
import { deleteSoinDevis } from "@/store/devis/actions"
  ...
  },
  {
  ...
  },
   {
    ...
    cell: ({ row }) => {
      ...
      const handleDeleteSoinDevis = async (id:number) =>{
        const response = await dispatch(deleteSoinDevis(id));
        ...
        <div>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={()=>{handleDeleteSoinDevis(soin.id)}} className="text-red-500">
                Supprimer
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
